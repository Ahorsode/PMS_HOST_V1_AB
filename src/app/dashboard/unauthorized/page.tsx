...
export default function UnauthorizedPage() {
  return (
    <div className="flex h-full min-h-[80vh] w-full items-center justify-center p-6 animate-in fade-in duration-700">
      <Card className="w-full max-w-md bg-[#1a1a1a]/80 border-white/10 overflow-hidden backdrop-blur-xl group">
        <CardContent className="p-8 flex flex-col items-center text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-white/60 text-sm font-bold w-full max-w-[280px] mx-auto">
              You do not have the required permissions to view this module. Please contact your Farm Owner or Manager.
            </p>
          </div>

          <Link href="/dashboard" className="glass-pill px-8 py-3 rounded-2xl flex items-center gap-2 group/btn hover:bg-emerald-500/20 hover:border-emerald-500/30 transition-all duration-300">
