...
export function PermissionsModal({ isOpen, onClose, staffName, initialPermissions, onSave, isLoading }: PermissionsModalProps) {
  const [permissions, setPermissions] = useState({
    canViewFinance: initialPermissions?.canViewFinance || false,
    canEditFinance: initialPermissions?.canEditFinance || false,
    canViewInventory: initialPermissions?.canViewInventory || false,
